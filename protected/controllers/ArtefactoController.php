...
class ArtefactoController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Artefacto']))
		{
			$model->attributes=$_POST['Artefacto'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('Artefacto');
	 ...
	 * @return Artefacto the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Artefacto::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='artefacto-form')
		{
