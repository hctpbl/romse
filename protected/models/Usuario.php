...
class Usuario extends CActiveRecord {
	...
	public function rules() {
		...
		return array (
				array (
						'nss, dni, nombre, apellidos, fecha_nacimiento, numero_telefono, salario, fecha_incorporacion, username, password, rol_id',
						'required' 
				),
				array (
						'rol_id',
				...
				array (
						'id, nss, dni, nombre, apellidos, fecha_nacimiento, numero_telefono, salario, fecha_incorporacion, fecha_baja, username, password, rol_id',
						'safe',
						'on' => 'search' 
				) 
		);
	...
	public function relations() {
		...
		return array (
				'solicitudDeCambios' => array (
						self::MANY_MANY,
						'SolicitudDeCambio',
						'cambio_de_estado(solicitante_id, solicitud_de_cambio_id)' 
				),
				'solicitudDeCambios1' => array (
						self::HAS_MANY,
						'SolicitudDeCambio',
						'creador' 
				),
				'solicitudDeCambios2' => array (
						self::HAS_MANY,
						'SolicitudDeCambio',
						'desarrollador' 
				),
				'solicitudDeCambios3' => array (
						self::HAS_MANY,
						'SolicitudDeCambio',
						'probador' 
				),
